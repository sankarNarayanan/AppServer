...
def get_json_changepoint():
    ...
    ret =[ {"title":"2019-Q1","values":[
        ...
        {"title":"2019-Q2","values":[
        {"desc_type":"graph","img":url+"/images/timesheet.png","title":"May - Week 1","version":"Healthy : > 90%","smallDesc":"NS - Not Submitted \n SA - Submitted & Approved, SNA - Submitted & Not Approved",
            "description": "NS - Not Submitted, \n SA - Submitted & Approved, SNA - Submitted & Not Approved", "graphs":[{"type":"bar","url":url+"/get/data/bar","title":"Timesheet Compliance"}]},
        {"desc_type":"graph","img":url+"/images/timesheet.png","title":"May - Week 2","version":"Moderate: 60 - 80%","smallDesc":"NS - Not Submitted \n SA - Submitted & Approved, SNA - Submitted & Not Approved",
            "description": "NS - Not Submitted, \n SA - Submitted & Approved, SNA - Submitted & Not Approved","graphs":[{"type":"bar","url":url+"/get/data/bar","title":"Timesheet Compliance"}]},
...
def get_json():
    ...
    ret =[ {"title":"Org Data","values":[
        {"desc_type":"graph","img":url+"/images/org.png","title":"DES","version":"Healthy : > 90%","smallDesc":"NS - Not Submitted \n SA - Submitted & Approved, SNA - Submitted & Not Approved",
            "description": "NS - Not Submitted, \n SA - Submitted & Approved, SNA - Submitted & Not Approved", "graphs":[{"type":"bar","url":url+"/get/data/bar","title":"Timesheet Compliance"}, {"type":"pie","title":"Percentage split up","url":url+"/get/data/pie"}]},
